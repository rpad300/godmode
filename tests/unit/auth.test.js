...
// NOTE: use global override hooks in src/supabase/client.js
...
describe('Auth Module', () => {
    ...
    beforeEach(() => {
        ...
        global.__SUPABASE_CLIENT_MOCK__ = mockSupabase;
        global.__SUPABASE_ADMIN_CLIENT_MOCK__ = mockAdminSupabase;
    ...
    describe('register()', () => {
        it('should return error when Supabase not configured', async () => {
            global.__SUPABASE_CLIENT_MOCK__ = null;
