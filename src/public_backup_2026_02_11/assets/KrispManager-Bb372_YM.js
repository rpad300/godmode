const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ProjectAssignmentModal-z0twUMjJ.js","assets/main-v_cFye9p.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-Cr-TCRi2.css"])))=>i.map(i=>d[i]);
import{v as D,c as P,u as F,w as N,o as p,L as R,M as T,N as V,O as K,P as U,Q as O,t as m,R as M,S as z,T as Q,_ as G,U as J,V as C,W,X,Y as L}from"./main-v_cFye9p.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const x="krisp-manager-modal";let i={activeTab:"transcripts",transcripts:[],quarantine:[],mappings:[],loading:!1,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:""},projects:[],selectedProjectId:""},b=null;async function ge(e="transcripts"){i={activeTab:e,transcripts:[],quarantine:[],mappings:[],loading:!1,selectedTranscript:null,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:"",domain:""},projects:[],selectedProjectId:""};const t=document.querySelector(`[data-modal-id="${x}"]`);t&&t.remove();const s=P("div",{className:"krisp-manager"});b=s,s.innerHTML=`
    <style>
      .krisp-manager {
        min-height: 450px;
        padding-bottom: 16px;
  ...
  `}function se(e){const{label:t}=M(e.status),s=z(e.duration_minutes),r=e.meeting_date?new Date(e.meeting_date).toLocaleDateString():"-";return`
...
//# sourceMappingURL=KrispManager-Bb372_YM.js.map
