const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ProjectAssignmentModal-BFkXe-kE.js","assets/main-BO04R03Y.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-BXb4IGK8.css"])))=>i.map(i=>d[i]);
import{d as D,c as L,e as F,i as N,o as l,j as R,k as P,l as V,m as K,n as U,p as O,t as m,q as M,r as T,s as Q,_ as G,u as J,v as C,w as W,x as X,y as I}from"./main-BO04R03Y.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const k="krisp-manager-modal";let s={activeTab:"transcripts",transcripts:[],quarantine:[],mappings:[],loading:!1,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:""},projects:[],selectedProjectId:""},b=null;async function ue(e="transcripts"){s={activeTab:e,transcripts:[],quarantine:[],mappings:[],loading:!1,selectedTranscript:null,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:"",domain:""}};const t=document.querySelector(`[data-modal-id="${k}"]`);t&&t.remove();const r=L("div",{className:"krisp-manager"});b=r,r.innerHTML=`
    <style>
      .krisp-manager {
        min-height: 450px;
        padding-bottom: 16px;
...
//# sourceMappingURL=KrispManager-utLLmchE.js.map
