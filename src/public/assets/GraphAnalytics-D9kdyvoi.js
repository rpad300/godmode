import{d as f,o as v,t as r,m as l}from"./main-BEBbDhZA.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function H(t={}){const i={stats:null,communities:[],centrality:{topNodes:[]},bridges:[],insights:[],isLoading:!0},n=f("div",{className:"graph-analytics"});return n.innerHTML=`
        ...
        <div class="community-card" data-id="${s.id}">
          ...
          ${s.members.slice(0,3).map(d=>`
            <div class="community-member">
              <span class="member-type" style="--member-type-color: ${m(d.type)}">${d.type}</span>
