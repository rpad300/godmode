import{c as f,o as v,t as r,g as l}from"./main-DWLLl9lh.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function H(t={}){const i={stats:null,communities:[],centrality:{topNodes:[]},bridges:[],insights:[],isLoading:!0},n=f("div",{className:"graph-analytics"});return n.innerHTML=`
      ...
      ${i.communities.slice(0,6).map((s,c)=>`
        <div class="community-card" data-id="${s.id}">
          <div class="community-header">
            <div class="community-color" style="background: ${a[c%a.length]}"></div>
          ...
          ${s.members.slice(0,3).map(d=>`
            <div class="community-member">
              <span class="member-type" style="color: ${g(d.type)}">${d.type}</span>
      ...
      ${i.centrality.topNodes.slice(0,10).map((s,c)=>`
        <div class="key-person" data-id="${s.id}">
          ...
          <div class="person-avatar">
            ${s.avatarUrl?`<img src="${s.avatarUrl}" alt="" onerror="this.style.display='none'">`:`<div class="avatar-placeholder">${M(s.name)}</div>`}
          </div>
          ...
          <div class="person-metrics">
            <div class="connections-bar-container">
              <div class="connections-bar" style="width: ${s.connections/a*100}%"></div>
            </div>
  ...
  `,e.querySelectorAll(".bridge-node").forEach(a=>{v(a,"click",()=>{const s=a.getAttribute("data-id");s&&n.onNodeSelect?.(s)})})}}function m(t,i){const n=t.querySelector("#ai-insights");if(n){if(i.insights.length===0){n.innerHTML=`
      <div class="empty-state-small">
...
//# sourceMappingURL=GraphAnalytics-Ddo1OUk0.js.map
