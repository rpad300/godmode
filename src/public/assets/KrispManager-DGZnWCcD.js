const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ProjectAssignmentModal-DT2g1EdV.js","assets/main-DsXjfhBM.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-Cp526G2r.css"])))=>i.map(i=>d[i]);
import{r as D,c as P,u as F,v as N,o as p,w as R,x as z,y as V,z as K,A as U,B as O,t as m,C as M,D as T,E as Q,_ as G,F as J,G as C,H as W,I as X,J as L}from"./main-DsXjfhBM.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const x="krisp-manager-modal";let i={activeTab:"transcripts",transcripts:[],quarantine:[],mappings:[],loading:!1,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:""},projects:[],selectedProjectId:""},b=null;async function ge(e="transcripts"){i={activeTab:e,transcripts:[],quarantine:[],mappings:[],loading:!1,selectedTranscript:null,mcpMeetings:[],importedIds:new Set,selectedMeetings:new Set,importFilters:{search:"",after:"",before:"",domain:""}};const t=document.querySelector(`[data-modal-id="${x}"]`);t&&t.remove();const s=P("div",{className:"krisp-manager"});b=s,s.innerHTML=`
    <style>
      .krisp-manager {
        min-height: 450px;
        padding-bottom: 16px;
  ...
  `,t?.meetings&&(i.mcpMeetings=t.meetings.map(o=>({meeting_id:o.krisp_meeting_id,name:o.meeting_name,date:o.meeting_date,speakers:o.speakers,attendees:o.attendees,meeting_notes:{key_points:o.key_points,action_items:o.action_items}})),i.importedIds=new Set(t.meetings.filter(o=>o.is_imported).map(o=>o.krisp_meeting_id))),le(e)}function de(e){return e.length===0?`
      <div class="krisp-empty">
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"/>
        </svg>
...
//# sourceMappingURL=KrispManager-DGZnWCcD.js.map
