const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GraphCanvas-BXRRly2f.js","assets/main-DsXjfhBM.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-Cp526G2r.css","assets/GraphVisualization-CYQEdwqv.js","assets/OntologyViewer-DXr26JOc.js","assets/QueryBuilder-C-zO4vRp.js","assets/GraphAnalytics-C12LRDIt.js","assets/AICopilot-Yz8O3oSG.js","assets/CommandPalette-Ch2qWUoX.js"])))=>i.map(i=>d[i]);
import{c as S,o as d,t as r,_ as u,d as M,n as p}from"./main-DsXjfhBM.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function V(e={}){const t={activeTab:"explorer",isLoading:!0,stats:null,selectedNode:null,isCopilotOpen:!1,isCommandPaletteOpen:!1,renderer:"falkordb",filters:{entityTypes:[],communityId:null,searchQuery:""}},a=S("div",{className:"graph-explorer"});return a.innerHTML=`
  ...
  `;try{switch(a){case"explorer":await C(i,t,o);break;case"ontology":await q(i);break;case"query":await H(i,o);break;case"analytics":await N(i);break}}catch(n){console.error(`[GraphExplorer] Failed to load ${a} tab:`,n),i.innerHTML=`
    ...
    `}}}async function C(e,t,a){if(e.innerHTML="",t.renderer==="falkordb"){const{createGraphCanvas:o}=await u(async()=>{const{createGraphCanvas:i}=await import("./GraphCanvas-BXRRly2f.js");return{createGraphCanvas:i}},__vite__mapDeps([0,1,2,3])),s=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeRightClick:i=>{r.info(`${i.name||i.label||i.id}`)},onDataLoaded:i=>{t.stats={...t.stats,...i};const n=e.closest(".graph-explorer");n&&m(n,t.stats)}});e.appendChild(s)}else{const{createGraphVisualization:o}=await u(async()=>{const{createGraphVisualization:i}=await import("./GraphVisualization-CYQEdwqv.js");return{createGraphVisualization:i}},__vite__mapDeps([4,1,2,3])),s=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeDoubleClick:i=>{r.info(`Expanding connections for ${i.label||i.name||i.id}`)}});e.appendChild(s)}}async function q(e){const{createOntologyViewer:t}=await u(async()=>{const{createOntologyViewer:o}=await import("./OntologyViewer-DXr26JOc.js");return{createOntologyViewer:o}},__vite__mapDeps([5,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}async function H(e,t){const{createQueryBuilder:a}=await u(async()=>{const{createQueryBuilder:s}=await import("./QueryBuilder-C-zO4vRp.js");return{createQueryBuilder:s}},__vite__mapDeps([6,1,2,3]));e.innerHTML="";const o=a({onExecute:(s,i)=>{t.onQueryExecute?.(s)}});e.appendChild(o)}async function N(e){const{createGraphAnalytics:t}=await u(async()=>{const{createGraphAnalytics:o}=await import("./GraphAnalytics-C12LRDIt.js");return{createGraphAnalytics:o}},__vite__mapDeps([7,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}function k(e,t){const a=e.querySelector("#node-details-panel");if(!a)return;const o=t.avatarUrl||t.photoUrl||t.properties?.avatar_url||t.properties?.photo_url,s=t.role||t.properties?.role,i=t.organization||t.properties?.organization,n=t.email||t.properties?.email;a.innerHTML=`
