const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GraphCanvas-Cc6LnV2G.js","assets/index-CIQ-J7LH.js","assets/index-CwtqAywA.css","assets/GraphVisualization-DPnjWJDr.js","assets/OntologyViewer-B1FcQOnU.js","assets/QueryBuilder-BVORlDcz.js","assets/GraphAnalytics-CvYzVRHt.js","assets/AICopilot-DK4PaAis.js","assets/CommandPalette-CaDv55F0.js"])))=>i.map(i=>d[i]);
import{c as S,o as d,t as r,_ as u,g as p}from"./index-CIQ-J7LH.js";function I(e={}){const t={activeTab:"explorer",isLoading:!0,stats:null,selectedNode:null,isCopilotOpen:!1,isCommandPaletteOpen:!1,renderer:"falkordb",filters:{entityTypes:[],communityId:null,searchQuery:""}},a=S("div",{className:"graph-explorer"});return a.innerHTML=`
  ...
  `;try{switch(a){case"explorer":await C(i,t,o);break;case"ontology":await A(i);break;case"query":await q(i,o);break;case"analytics":await H(i);break}}catch(s){console.error(`[GraphExplorer] Failed to load ${a} tab:`,s),i.innerHTML=`
    ...
    `}}}async function C(e,t,a){if(e.innerHTML="",t.renderer==="falkordb"){const{createGraphCanvas:o}=await u(async()=>{const{createGraphCanvas:i}=await import("./GraphCanvas-Cc6LnV2G.js");return{createGraphCanvas:i}},__vite__mapDeps([0,1,2])),n=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeRightClick:i=>{r.info(`${i.name||i.label||i.id}`)},onDataLoaded:i=>{t.stats={...t.stats,...i};const s=e.closest(".graph-explorer");s&&m(s,t.stats)}});e.appendChild(n)}else{const{createGraphVisualization:o}=await u(async()=>{const{createGraphVisualization:i}=await import("./GraphVisualization-DPnjWJDr.js");return{createGraphVisualization:i}},__vite__mapDeps([3,1,2])),n=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeDoubleClick:i=>{r.info(`Expanding connections for ${i.label||i.name||i.id}`)}});e.appendChild(n)}}async function A(e){const{createOntologyViewer:t}=await u(async()=>{const{createOntologyViewer:o}=await import("./OntologyViewer-B1FcQOnU.js");return{createOntologyViewer:o}},__vite__mapDeps([4,1,2]));e.innerHTML="";const a=t({});e.appendChild(a)}async function q(e,t){const{createQueryBuilder:a}=await u(async()=>{const{createQueryBuilder:n}=await import("./QueryBuilder-BVORlDcz.js");return{createQueryBuilder:n}},__vite__mapDeps([5,1,2]));e.innerHTML="";const o=a({onExecute:(n,i)=>{t.onQueryExecute?.(n)}});e.appendChild(o)}async function H(e){const{createGraphAnalytics:t}=await u(async()=>{const{createGraphAnalytics:o}=await import("./GraphAnalytics-CvYzVRHt.js");return{createGraphAnalytics:o}},__vite__mapDeps([6,1,2]));e.innerHTML="";const a=t({});e.appendChild(a)}function k(e,t){const a=e.querySelector("#node-details-panel");if(!a)return;const o=t.avatarUrl||t.photoUrl||t.properties?.avatar_url||t.properties?.photo_url,n=t.role||t.properties?.role,i=t.organization||t.properties?.organization,s=t.email||t.properties?.email;a.innerHTML=`
