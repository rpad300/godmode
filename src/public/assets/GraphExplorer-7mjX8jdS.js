const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GraphCanvas-D-5twFn9.js","assets/main-BEBbDhZA.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-Ba17mlSV.css","assets/GraphVisualization-CD5nHIGE.js","assets/OntologyViewer-CRVpVxe6.js","assets/QueryBuilder-BS0zYO-G.js","assets/GraphAnalytics-D9kdyvoi.js","assets/AICopilot-BjLNRWs4.js","assets/CommandPalette-RLKct5vC.js"])))=>i.map(i=>d[i]);
import{d as S,o as d,t as r,_ as u,b as M,m as p}from"./main-BEBbDhZA.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function V(e={}){const t={activeTab:"explorer",isLoading:!0,stats:null,selectedNode:null,isCopilotOpen:!1,isCommandPaletteOpen:!1,renderer:"falkordb",filters:{entityTypes:[],communityId:null,searchQuery:""}},a=S("div",{className:"graph-explorer"});return a.innerHTML=`
  ...
  `;try{switch(a){case"explorer":await C(i,t,o);break;case"ontology":await q(i);break;case"query":await H(i,o);break;case"analytics":await N(i);break}}catch(n){console.error(`[GraphExplorer] Failed to load ${a} tab:`,n),i.innerHTML=`
    ...
    `}}}async function C(e,t,a){if(e.innerHTML="",t.renderer==="falkordb"){const{createGraphCanvas:o}=await u(async()=>{const{createGraphCanvas:i}=await import("./GraphCanvas-D-5twFn9.js");return{createGraphCanvas:i}},__vite__mapDeps([0,1,2,3])),s=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeRightClick:i=>{r.info(`${i.name||i.label||i.id}`)},onDataLoaded:i=>{t.stats={...t.stats,...i};const n=e.closest(".graph-explorer");n&&m(n,t.stats)}});e.appendChild(s)}else{const{createGraphVisualization:o}=await u(async()=>{const{createGraphVisualization:i}=await import("./GraphVisualization-CD5nHIGE.js");return{createGraphVisualization:i}},__vite__mapDeps([4,1,2,3])),s=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeDoubleClick:i=>{r.info(`Expanding connections for ${i.label||i.name||i.id}`)}});e.appendChild(s)}}async function q(e){const{createOntologyViewer:t}=await u(async()=>{const{createOntologyViewer:o}=await import("./OntologyViewer-CRVpVxe6.js");return{createOntologyViewer:o}},__vite__mapDeps([5,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}async function H(e,t){const{createQueryBuilder:a}=await u(async()=>{const{createQueryBuilder:s}=await import("./QueryBuilder-BS0zYO-G.js");return{createQueryBuilder:s}},__vite__mapDeps([6,1,2,3]));e.innerHTML="";const o=a({onExecute:(s,i)=>{t.onQueryExecute?.(s)}});e.appendChild(o)}async function N(e){const{createGraphAnalytics:t}=await u(async()=>{const{createGraphAnalytics:o}=await import("./GraphAnalytics-D9kdyvoi.js");return{createGraphAnalytics:o}},__vite__mapDeps([7,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}function k(e,t){const a=e.querySelector("#node-details-panel");if(!a)return;const o=t.avatarUrl||t.photoUrl||t.properties?.avatar_url||t.properties?.photo_url,s=t.role||t.properties?.role,i=t.organization||t.properties?.organization,n=t.email||t.properties?.email;a.innerHTML=`
