import{d as E,m as M,o as m,t as u,b as q}from"./main-BEBbDhZA.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function w(){return window.vis}const k={Person:"#6366f1",Project:"#22c55e",Document:"#8b5cf6",Decision:"#06b6d4",Risk:"#ef4444",Question:"#f59e0b",Fact:"#84cc16",Meeting:"#ec4899",Task:"#3b82f6",Technology:"#f97316",Organization:"#a855f7",Client:"#14b8a6",Email:"#e879f9",Conversation:"#9333ea",Answer:"#10b981",Briefing:"#eab308"};function F(e={}){const{height:t=600}=e,n=E("div",{className:"graph-visualization-container"});return n.innerHTML=`
  ...
  `,C(n,e),n}async function C(e,t){const n=e.querySelector("#viz-canvas"),s=e.querySelector("#viz-status");if(w()||await T(),!w()){n.innerHTML=`
      <div class="viz-error">
  ...
  `,n.classList.remove("hidden")}function I(e){const t=e.closest(".graph-visualization-container")?.querySelector("#viz-hover-card");t&&t.classList.add("hidden")}function P(e,t){const n=e.querySelector("#viz-legend");if(!n)return;const s={};t.forEach(o=>{s[o.type]=(s[o.type]||0)+1});const a=Object.entries(s).sort((o,c)=>c[1]-o[1]).slice(0,8);n.innerHTML=`
  ...
  `}function A(e){const t=e.properties||{},n=e.name||t.name||e.label||e.id,s=e.role||t.role,a=e.organization||t.organization,o=t.content?String(t.content).substring(0,100):null,c=[];return c.push(String(n)),c.push(`[${e.type}]`),s&&c.push(String(s)),a&&c.push(`@ ${a}`),o&&e.type!=="Person"&&c.push(`"${o}..."`),c.join(`
`)}function U(e){const t=e.connections||1;return Math.min(15+t*2,40)}function $(e){return e.split(" ").map(t=>t.charAt(0)).join("").substring(0,2).toUpperCase()}function z(e,t){const n=e.replace("#",""),s=Math.max(0,Math.min(255,parseInt(n.substring(0,2),16)+t)),a=Math.max(0,Math.min(255,parseInt(n.substring(2,4),16)+t)),o=Math.max(0,Math.min(255,parseInt(n.substring(4,6),16)+t));return`#${s.toString(16).padStart(2,"0")}${a.toString(16).padStart(2,"0")}${o.toString(16).padStart(2,"0")}`}function O(){return document.documentElement.getAttribute("data-theme")==="dark"?"#e5e7eb":"#374151"}function S(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}export{F as createGraphVisualization};
//# sourceMappingURL=GraphVisualization-CD5nHIGE.js.map
