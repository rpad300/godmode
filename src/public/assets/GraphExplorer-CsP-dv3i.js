const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GraphCanvas-CfLKMMdM.js","assets/main-CABUEUPe.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/main-CM94QBLC.css","assets/GraphVisualization-BO8o3dRm.js","assets/OntologyViewer-CMJ72yfd.js","assets/QueryBuilder-CdV-2NkZ.js","assets/GraphAnalytics-BgUhn95f.js","assets/AICopilot-7bzl4-QA.js","assets/CommandPalette-VNeH4MKX.js"])))=>i.map(i=>d[i]);
import{c as S,o as d,t as r,_ as u,g as p}from"./main-CABUEUPe.js";import"./modulepreload-polyfill-B5Qt9EMX.js";function F(e={}){const t={activeTab:"explorer",isLoading:!0,stats:null,selectedNode:null,isCopilotOpen:!1,isCommandPaletteOpen:!1,renderer:"falkordb",filters:{entityTypes:[],communityId:null,searchQuery:""}},a=S("div",{className:"graph-explorer"});return a.innerHTML=`
  ...
  `;try{switch(a){case"explorer":await C(i,t,o);break;case"ontology":await A(i);break;case"query":await q(i,o);break;case"analytics":await H(i);break}}catch(s){console.error(`[GraphExplorer] Failed to load ${a} tab:`,s),i.innerHTML=`
    ...
    `}}}async function C(e,t,a){if(e.innerHTML="",t.renderer==="falkordb"){const{createGraphCanvas:o}=await u(async()=>{const{createGraphCanvas:i}=await import("./GraphCanvas-CfLKMMdM.js");return{createGraphCanvas:i}},__vite__mapDeps([0,1,2,3])),n=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeRightClick:i=>{r.info(`${i.name||i.label||i.id}`)},onDataLoaded:i=>{t.stats={...t.stats,...i};const s=e.closest(".graph-explorer");s&&m(s,t.stats)}});e.appendChild(n)}else{const{createGraphVisualization:o}=await u(async()=>{const{createGraphVisualization:i}=await import("./GraphVisualization-BO8o3dRm.js");return{createGraphVisualization:i}},__vite__mapDeps([4,1,2,3])),n=o({height:e.clientHeight||600,onNodeClick:i=>{t.selectedNode=i,a.onNodeSelect?.(i),k(e.closest(".graph-explorer"),i)},onNodeDoubleClick:i=>{r.info(`Expanding connections for ${i.label||i.name||i.id}`)}});e.appendChild(n)}}async function A(e){const{createOntologyViewer:t}=await u(async()=>{const{createOntologyViewer:o}=await import("./OntologyViewer-CMJ72yfd.js");return{createOntologyViewer:o}},__vite__mapDeps([5,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}async function q(e,t){const{createQueryBuilder:a}=await u(async()=>{const{createQueryBuilder:n}=await import("./QueryBuilder-CdV-2NkZ.js");return{createQueryBuilder:n}},__vite__mapDeps([6,1,2,3]));e.innerHTML="";const o=a({onExecute:(n,i)=>{t.onQueryExecute?.(n)}});e.appendChild(o)}async function H(e){const{createGraphAnalytics:t}=await u(async()=>{const{createGraphAnalytics:o}=await import("./GraphAnalytics-BgUhn95f.js");return{createGraphAnalytics:o}},__vite__mapDeps([7,1,2,3]));e.innerHTML="";const a=t({});e.appendChild(a)}function k(e,t){const a=e.querySelector("#node-details-panel");if(!a)return;const o=t.avatarUrl||t.photoUrl||t.properties?.avatar_url||t.properties?.photo_url,n=t.role||t.properties?.role,i=t.organization||t.properties?.organization,s=t.email||t.properties?.email;a.innerHTML=`
