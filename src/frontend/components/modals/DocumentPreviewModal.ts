...
function downloadDocument(doc: Document): void {
  // Use inline preview route so PDFs/images open in a tab instead of always downloading.
  // Users don't need direct Google Drive permissions; backend proxies Drive-backed docs.
