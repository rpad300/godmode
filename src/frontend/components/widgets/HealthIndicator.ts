...
export function createHealthIndicator(props: HealthIndicatorProps): HTMLElement {
  ...
  // Push dynamic styling via CSS variables (avoid inline style="...")
  indicator.style.setProperty('--health-color', health.color);
  indicator.style.setProperty('--health-dash', String((health.score / 100) * 126));
