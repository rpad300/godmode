...
import { getSettingsMarkup, bindSettingsEvents } from './modals/SettingsModal';
import { showCompaniesModal } from './modals/CompaniesModal';
...
export function initSettingsPage(
  ...
  bindSettingsEvents(container, {
    ...
    onManageCompanies: () => showCompaniesModal(),
